...
/* harmony import */ var _modules_redux_rootReducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/redux/rootReducer */ "./src/js/modules/redux/rootReducer.js");
...
/* harmony import */ var _modules_nav__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/nav */ "./src/js/modules/nav.js");
/* harmony import */ var _modules_scrollContent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/scrollContent */ "./src/js/modules/scrollContent.js");
...
/* harmony import */ var _modules_countTime__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/countTime */ "./src/js/modules/countTime.js");
/* harmony import */ var _modules_updateStore__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/updateStore */ "./src/js/modules/updateStore.js");
/* harmony import */ var _modules_animateContent__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/animateContent */ "./src/js/modules/animateContent.js");
// Main JS module
...
var store = Object(redux__WEBPACK_IMPORTED_MODULE_1__["createStore"])(_modules_redux_rootReducer__WEBPACK_IMPORTED_MODULE_2__["rootReducer"], window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  object_fit_images__WEBPACK_IMPORTED_MODULE_3___default()();
  Object(_modules_nav__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_scrollContent__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_countTime__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_updateStore__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_modules_animateContent__WEBPACK_IMPORTED_MODULE_9__["default"])();
});

/***/ }),

/***/ "./src/js/modules/animateContent.js":
/*!******************************************!*\
  !*** ./src/js/modules/animateContent.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return animateContent; });
function animateContent() {
  ...
  function rotateBtns(e) {
    if (rotatedBtns.length > 0) {
      ...
      for (var i = 0; i < rotatedBtns.length; i++) {
        _loop(i);
      }
    }
  }
  ...
  if (accordion !== undefined && accordion !== null) {
    (function () {
      var accTriggers = document.getElementsByClassName("reasons__accordion-trigger");
      var accItems = document.getElementsByClassName("reasons__accordion-item");
      ...
      var interval = setInterval(function () {
        if (accItems[itemIndex].style.display !== "block") {
          for (var _i = 0; _i < accItems.length; _i++) {
            $(accItems[_i]).slideUp();
          }
      ...
      var _loop2 = function _loop2(_i2) {
        accTriggers[_i2].addEventListener("click", function () {
          itemIndex = _i2;
          ...
          if (panel.style.display === "block") {
            ...
            for (var _i3 = 0; _i3 < accItems.length; _i3++) {
              $(accItems[_i3]).slideUp();
            }
      ...
      for (var _i2 = 0; _i2 < accTriggers.length; _i2++) {
        _loop2(_i2);
      }
  ...
  var media_check_max = window.matchMedia("(max-width: 991.9px)");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return countTime; });
function countTime() {
  var DEADLINE = new Date(Date.parse(new Date()) + 6 * 60 * 60 * 1000);
  var INTERVAL = 1000; // ms

  var clock = document.getElementById("countdown"); // const daysSpan = clock.querySelector('.days');
  ...
  function initializeClock() {
    ...
    var t = getTimeRemaining(remindedTime);
...
function nav() {
  var burger_button = document.querySelector('.nav__burger');
  var burgerNav = $('.burger-menu');
  var burgerNavItems = document.querySelectorAll(".burger-menu__link");
  ...
  function navHandler() {
    ...
    for (var i = 0; i < burgerNavItems.length; i++) {
...
/***/ "./src/js/modules/redux/actions.js":
/*!*****************************************!*\
  !*** ./src/js/modules/redux/actions.js ***!
  \*****************************************/
/*! exports provided: setPrices, setProducts, addToCart, removeFromCart, incrementItem, decrementItem, setItemSize, removeItemSize, setErrors */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setItemSize", function() { return setItemSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeItemSize", function() { return removeItemSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setErrors", function() { return setErrors; });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "./src/js/modules/redux/types.js");

function setPrices(_ref) {
  var price = _ref.price,
      oldPrice = _ref.oldPrice,
      currency = _ref.currency;
  return {
    type: _types__WEBPACK_IMPORTED_MODULE_0__["SET_PRICES"],
    payload: {
      price: price,
      oldPrice: oldPrice,
      currency: currency
...
function removeFromCart(id) {
  return {
    type: _types__WEBPACK_IMPORTED_MODULE_0__["REMOVE_FROM_CART"],
    payload: id
  };
}
...
function decrementItem(id) {
  return {
    type: _types__WEBPACK_IMPORTED_MODULE_0__["DECREMET_ITEM"],
    payload: id
  };
}
function setItemSize(id, size, position) {
  return {
    type: _types__WEBPACK_IMPORTED_MODULE_0__["SET_ITEM_SIZE"],
    payload: {
      id: id,
      size: size,
      position: position
...
function removeItemSize(id, position) {
  return {
    type: _types__WEBPACK_IMPORTED_MODULE_0__["REMOVE_ITEM_SIZE"],
    payload: {
      id: id,
      position: position
    }
...
/***/ "./src/js/modules/redux/rootReducer.js":
/*!*********************************************!*\
  !*** ./src/js/modules/redux/rootReducer.js ***!
  \*********************************************/
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types */ "./src/js/modules/redux/types.js");
...
function cartReducer() {
  ...
  switch (action.type) {
    case _types__WEBPACK_IMPORTED_MODULE_1__["SET_PRICES"]:
    ...
    case _types__WEBPACK_IMPORTED_MODULE_1__["SET_PRODUCTS"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        products: action.payload
      });

    case _types__WEBPACK_IMPORTED_MODULE_1__["ADD_TO_CART"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        products: state.products.map(function (product) {
          var p = _objectSpread({}, product);
    ...
    case _types__WEBPACK_IMPORTED_MODULE_1__["REMOVE_FROM_CART"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        products: state.products.map(function (product) {
          var p = _objectSpread({}, product);
    ...
    case _types__WEBPACK_IMPORTED_MODULE_1__["INCREMENT_ITEM"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        products: state.products.map(function (product) {
          var p = _objectSpread({}, product);
          ...
          if (p.id == action.payload) {
            ...
            var pSizes = _toConsumableArray(p.sizes);
    ...
    case _types__WEBPACK_IMPORTED_MODULE_1__["DECREMET_ITEM"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        products: state.products.map(function (product) {
          var p = _objectSpread({}, product);
    ...
    case _types__WEBPACK_IMPORTED_MODULE_1__["SET_ITEM_SIZE"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        products: state.products.map(function (product) {
          var p = _objectSpread({}, product);
    ...
    case _types__WEBPACK_IMPORTED_MODULE_1__["REMOVE_ITEM_SIZE"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        products: state.products.map(function (product) {
          var p = _objectSpread({}, product);
          ...
          if (p.id == action.payload.id) {
            if (p.count == 1) {
              ...
              var pSizes = p.sizes.filter(function (s, i) {
                return i != action.payload.position;
              });
              p.sizes = pSizes;
...
/***/ "./src/js/modules/redux/types.js":
/*!***************************************!*\
  !*** ./src/js/modules/redux/types.js ***!
  \***************************************/
/*! exports provided: SET_PRICES, SET_PRODUCTS, ADD_TO_CART, REMOVE_FROM_CART, INCREMENT_ITEM, DECREMET_ITEM, SET_ITEM_SIZE, REMOVE_ITEM_SIZE, SET_ERRORS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_PRICES", function() { return SET_PRICES; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DECREMET_ITEM", function() { return DECREMET_ITEM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ITEM_SIZE", function() { return SET_ITEM_SIZE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "REMOVE_ITEM_SIZE", function() { return REMOVE_ITEM_SIZE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ERRORS", function() { return SET_ERRORS; });
//order types
var SET_PRICES = "SET_PRICES";
var SET_PRODUCTS = "SET_PRODUCTS";
var ADD_TO_CART = "ADD_TO_CART";
var REMOVE_FROM_CART = "REMOVE_FROM_CART";
var INCREMENT_ITEM = "INCREMENT_ITEM";
var DECREMET_ITEM = "DECREMET_ITEM";
var SET_ITEM_SIZE = "SET_ITEM_SIZE";
var REMOVE_ITEM_SIZE = "REMOVE_ITEM_SIZE";
var SET_ERRORS = "SET_ERRORS";

/***/ }),

/***/ "./src/js/modules/scrollContent.js":
/*!*****************************************!*\
  !*** ./src/js/modules/scrollContent.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return scrollContent; });
...
function slider() {
  var productSliders = $('.js_productSlider');
  var testimonialsSlider = $('#js_testimonialsSlider');
  var slideIconImgs = $(".testimonials__slide-icon-wrapper");
  var bigImages = $(".testimonials__slide-img");
  ...
  if (testimonialsSlider) {
    ...
    $(testimonialsSlider).on('beforeChange', function (event, slick, currentSlide, nextSlide) {
      var thisSlide = $(this).find(".slick-current");
      var chosenImgIcon = thisSlide.find(".chosen");
  ...
  if (slideIconImgs.length > 0) {
    var testimonialsSliderList = testimonialsSlider.find(".slick-list");
    slideIconImgs.each(function () {
      $(this).on("click", function () {
        var __this = $(this);

        var chosenIconImg = __this.find(".testimonials__slide-img-icon");

        var chosenIconImgSrc = chosenIconImg.attr("src");
        var chosenIconImgAlt = chosenIconImg.attr("alt");
        var chosenIconImgSrcset = chosenIconImg.attr("srcset");

        var imagesWrapper = __this.closest(".testimonials__slide-images-wrapper");

        var chosenImg = imagesWrapper.find(".testimonials__slide-img");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return updateStore; });
/* harmony import */ var underscore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! underscore */ "./node_modules/underscore/modules/index-all.js");
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./redux/actions */ "./src/js/modules/redux/actions.js");
...
function updateStore() {
  ...
  _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["setProducts"])(underscore__WEBPACK_IMPORTED_MODULE_0__["default"].map(cards, function (card) {
    var img = $(card).find(".assortment__card-img");
    return {
      id: $(card).data("id"),
  ...
  var _store$getState$cart = _main__WEBPACK_IMPORTED_MODULE_2__["store"].getState().cart,
      productsPrev = _store$getState$cart.products,
      pricePrev = _store$getState$cart.price,
      oldPricePrev = _store$getState$cart.oldPrice,
      currencyPrev = _store$getState$cart.currency,
      hasErrorsPrev = _store$getState$cart.hasErrors; //card Variables

  var totalItems = 0;
  var sizedItems = 0; //get cards DOM elements

  var cardBtns = $(".js_card-btn");
  var incItem = $(".js_inc-item");
  var decItem = $(".js_dec-item");
  var itemSize = $(".assortment__card-sizes span");
  var removeItem = $(".js_card-remove"); //get cart DOM

  var orderGift = $(".order__gift").hide();
  var orderTable = $(".order__table-wrapper").hide();
  var totalItemsNode = $(".js__total-items");
  ...
  var orderCountTitle = orderTable.find(".order_count-title").text();
  var orderSizeTitle = orderTable.find(".order_size-title").text();
  var orderPriceTitle = orderTable.find(".order_price-title").text();
  var orderSizeError = orderTable.find(".order_size-error").text(); //set card events

  cardBtns.on("click", function (e) {
    e.preventDefault(); //get card

    var card = $(this).parents(".assortment__card");
    if (!card.length) return; //dispatch new item

    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["addToCart"])(card.data("id")));
  });
  incItem.on("click", function (e) {
    e.preventDefault(); //get card

    var card = $(this).parents(".assortment__card");
    if (!card.length) return; //dispatch increment item

    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["incrementItem"])(card.data("id")));
  });
  decItem.on("click", function (e) {
    e.preventDefault(); //get card

    var card = $(this).parents(".assortment__card");
    if (!card.length) return; //dispatch decrement item

    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["decrementItem"])(card.data("id")));
  });
  itemSize.on("click", function (e) {
    e.preventDefault();
    var card = $(this).parents(".assortment__card");
    if (!card.length) return;
    var cardID = card.data("id"); //set first size

    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["setItemSize"])(cardID, $(this).text(), 0));
  });
  removeItem.on("click", function (e) {
    ...
    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["removeFromCart"])(card.data("id")));
  }); //set order events
  //add size for product

  $(document).on("click", ".js_order-add", function (e) {
    e.preventDefault();
    var product = $(this).parents("[data-id]");
    if (!product.length) return; //dispatch remove from order

    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["incrementItem"])(product.data("id")));
  }); //remove one size from cart

  $(document).on("click", ".js_order-remove", function (e) {
    e.preventDefault();
    var product = $(this).parents("[data-id]");
    var productRow = $(this).parents("[data-index]");
    if (!product.length || !productRow.length) return; //dispatch remove from order

    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["removeItemSize"])(product.data("id"), productRow.data("index")));
  }); //show sizes

  $(document).on("click", ".js_show-size", function (e) {
    e.preventDefault();
    var productRow = $(this).parents(".order__table-subrow");
  ...
  $(document).on("click", ".js_set-size", function (e) {
    ...
    var product = $(this).parents("[data-id]");
    var productRow = $(this).parents("[data-index]");
    if (!product.length || !productRow.length) return; //dispatch set size from order

    _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["setItemSize"])(product.data("id"), $(this).text(), productRow.data("index")));
  });
  orderSubmit.on("click", function (e) {
    if ($(this).hasClass("disabled")) {
      ...
      e.preventDefault();
      _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["setErrors"])(true));
    } else {
      _main__WEBPACK_IMPORTED_MODULE_2__["store"].dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_1__["setErrors"])(false));
    }
  }); //methods

  function changeProductState(product) {
    //find card
    var card = $(".assortment__card[data-id=\"".concat(product.id, "\"]")); //set active class
    ...
    card.find(".assortment__card-count-number").text(product.count); //set changed size

    var cardSizes = card.find(".assortment__card-sizes span");
    cardSizes.removeClass("active");

    if (product.sizes[0]) {
      cardSizes.filter(".assortment__card-size-".concat(product.sizes[0].toLowerCase())).addClass("active");
    }
  } //toggle submit btn


  function toggleSubmitBtn(itemsCount) {
    if (itemsCount > 0) orderSubmit.removeClass("disabled");else orderSubmit.addClass("disabled");
  } //update cart method
  ...
  function updateCart(products, oldPrice, price, currency, hasErrors) {
    ...
    emptyCartError.hide();
    var allSizes = ["S", "M", "L", "XL", "XXL", "XXXL", "4XL", "5XL", "6XL"];
    var formProductsVal = "";
    totalItems = 0;
    sizedItems = 0;
    var orderRows = products.reduce(function (productsRows, product) {
      if (product.added) {
        // create product row
        var orderProduct = $("<div class=\"order__table-row\" data-id=".concat(product.id, "></div>"));
        orderProduct.append(product.sizes.map(function (size, index) {
          totalItems++;

          if (size) {
            formProductsVal += "".concat(product.name, " - ").concat(size, "; ");
            sizedItems++;
          }

          formProducts.val;
          var productRow = $("<div class=\"order__table-subrow ".concat(index ? "order__table-row-same" : "order__table-row-first").concat(!size && hasErrors ? " sizes-shown error" : "", "\" data-index=\"").concat(index, "\"></div>")); //append add button

          productRow.append("<div class='order__table-column1'><div class='order__table-add-btn js_order-add'><div class='order__table-add-icon'></div></div></div>"); //append img & title

          productRow.append("<div class='order__table-column2'><img class=\"order__table-product-img\" src=\"".concat(product.img, "\" srcset=\"").concat(product.img2x, "\" alt=\"").concat(product.imgAlt, "\" /><p class=\"order__table-product-title\">").concat(product.name, "</p></div>")); //append count & size
  ...
  _main__WEBPACK_IMPORTED_MODULE_2__["store"].subscribe(function () {
    var _store$getState$cart2 = _main__WEBPACK_IMPORTED_MODULE_2__["store"].getState().cart,
        products = _store$getState$cart2.products,
        price = _store$getState$cart2.price,
        oldPrice = _store$getState$cart2.oldPrice,
        currency = _store$getState$cart2.currency,
        hasErrors = _store$getState$cart2.hasErrors;

    if (!underscore__WEBPACK_IMPORTED_MODULE_0__["default"].isEqual(products, productsPrev) || hasErrors != hasErrorsPrev) {
      updateCart(products, oldPrice, price, currency, hasErrors);
      products.forEach(function (product, index) {
        if (underscore__WEBPACK_IMPORTED_MODULE_0__["default"].isEqual(product, productsPrev[index])) return;
...
module.exports = __webpack_require__(/*! D:\dilexi\dilexi_ro\src\js\main.js */"./src/js/main.js");
