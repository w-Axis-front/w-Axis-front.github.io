...
/* harmony import */ var _modules_masonryGrid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/masonryGrid */ "./src/js/modules/masonryGrid.js");
...
/* harmony import */ var _modules_popupContent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/popupContent */ "./src/js/modules/popupContent.js");
// Main JS module
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(function () {
  ...
  Object(_modules_masonryGrid__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_scrollContent__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_popupContent__WEBPACK_IMPORTED_MODULE_6__["default"])();
});

/***/ }),

/***/ "./src/js/modules/masonryGrid.js":
/*!***************************************!*\
  !*** ./src/js/modules/masonryGrid.js ***!
  \***************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return masonryGrid; });
...
function masonryGrid() {
  var grid = document.querySelector('.js_grid');
  ...
  var media_check_min = window.matchMedia("(min-width: 768px)");
...
function nav() {
  ...
  var fullNav = $('.nav__wrap');
  var logoImg = $(".nav__logo-img");
  var logoImgCollapsed = $(".nav__logo-img-collapsed");
  var wrapNav = $(".nav__wrap-menu");
  var langBlock = $(".nav__lang");
  var burgerNavAnchor = document.querySelector(".js_burger-menu-anchor");
  ...
  function dropMenu() {
    if (burger_button.classList.contains('nav__burger--active')) {
      ...
      burgerNav.show(); // document.querySelector('.burger-menu').style.display = 'block';
  ...
  function scrollHandler(media_check_min) {
    ...
    if (media_check_min.matches) {
      burgerNav.hide(); // wrapNav.stop().css("display", "flex");
  ...
  var media_check_min = window.matchMedia("(min-width: 992px)");
...
/***/ "./src/js/modules/popupContent.js":
/*!****************************************!*\
  !*** ./src/js/modules/popupContent.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return popupContent; });
function popupContent() {
  var trigger = document.getElementById("js_popup-trigger");
  var btnPopupClose = document.getElementById("js_close-popup");
...
function scrollContent() {
  ...
  function animateItemOnScroll(animatedItem, idx, mainSlider) {
    window.addEventListener("scroll", function () {
      document.body.style.setProperty(styleProperties[idx], (window.pageYOffset - mainSlider.offsetHeight - animatedItem.offsetHeight * idx) / animatedItem.offsetHeight);
    }, false);
  }
  ...
  var media_check_max = window.matchMedia("(max-width: 767.9px)");
...
function slider() {
  ...
  var bgColors = ["rgba(252, 213, 196, 0.42)", "rgba(215, 240, 245, 0.54)", "rgba(178, 214, 248, 0.35)", "rgba(246, 208, 231, 0.4)", "rgba(208, 149, 106, 0.2)"];
  $(slider1).on('beforeChange', function (event, slick, currentSlide, nextSlide) {
    slider1.css({
      "background-color": bgColors[nextSlide]
    });
    var direction;
    ...
    slides.each(function () {
      ...
      var img1 = $(this).find(".main-slider__slide-img1"),
          img2 = $(this).find(".main-slider__slide-img2"),
          img3 = $(this).find(".main-slider__slide-img3"); // Animate images:
